...
export default function Hero() {
  ...
  return (
    <div id='home-hero' className='h-screen w-screen flex flex-row p-8 justify-between items-center relative'>
      <div className='h-auto w-4/10 overflow-hidden absolute top-1/3 flex flex-col items-center'>
        ...
        <button className='enter bg-green-400 text-white px-6 py-3 rounded-lg  cursor-pointer'>Get Started</button>
      </div>
